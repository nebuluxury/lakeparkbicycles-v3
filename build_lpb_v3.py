...
{FONTS}
<link rel="stylesheet" href="assets/styles.css?v=39">{jsonld}
</head>
<body>
{ticker()}
{header(active)}
...
EBIKES = [
 {"slug":"vetus-1","name":"Vetus 1 Fat Tire","type":"Fat-tire e-bike","stock":True,"pa":"749","pb":"699","colors":[],
  ...
  "blurb":"The Vetus 1 is our go-anywhere fat-tire e-bike. Full suspension and 20-inch by 4-inch tires soak up sand, gravel and curbs, while a 1000W peak motor gives it real muscle for the climbs and open stretches. It is TUV and UL 2849 certified, and every one leaves the shop fully built, tuned and safety-checked by Tony.",
...
def _ebike_card(b, related=False):
    ...
    return ('<a class="tile ebike-card" href="ebike-'+b["slug"]+'.html"><div class="ph">'+ov
            +'<img src="assets/img/ebikes/'+b["imgs"][0]+'?v=3" alt="'+b["name"]+'" loading="lazy"></div>'
...
def build_ebike(b):
    imgs=b["imgs"]
    thumbs="".join(
      '<img src="assets/img/ebikes/%s?v=3" alt="%s"%s onclick="document.getElementById(&#39;pdp-main-img&#39;).src=this.src">'
    ...
    body=('<section class="page-hero" style="padding-bottom:10px"><div class="in">'
     ...
     '<div class="pdp-gallery" data-reveal><div class="pdp-main"><img id="pdp-main-img" src="assets/img/ebikes/'+imgs[0]+'?v=3" alt="'+b["name"]+'"></div>'
